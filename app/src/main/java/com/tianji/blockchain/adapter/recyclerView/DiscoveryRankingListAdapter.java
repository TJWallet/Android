 ...
 * author:jason
 **/
public class DiscoveryRankingListAdapter extends ItemClickableAdapter<DappEntity> {
    ...
    public DiscoveryRankingListAdapter(Context context, List<DappEntity> data) {
        this.context = context;
        this.data = data;
    }

    public DiscoveryRankingListAdapter(Context context, List<DappEntity> data, int displayNumber) {
        this.context = context;
        this.data = data;
    ...
    protected void onBindContentViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        DiscoveryRankingListAdapter.ViewHolder itemView = (DiscoveryRankingListAdapter.ViewHolder) holder;
...
//        ImageLoader.getInstance().displayImage(itemData.getIcon(), itemView.ivIcon);
        ...
        itemView.tvIndex.setText((position + 1) + "");
    ...
    protected RecyclerView.ViewHolder getTypeContentViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new DiscoveryRankingListAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_discovery_ranking, parent, false));
    }
