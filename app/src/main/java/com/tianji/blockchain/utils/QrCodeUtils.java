...
public class QrCodeUtils {
     ...
     * @return BitMap
     */
    public static Bitmap createSimpleQRCodeBitmap(String content, int width, int height,
     ...
     * @return
     */
    public static Bitmap createQRCodeBitmapWithLogo(String content, int width, int height, String character_set,
